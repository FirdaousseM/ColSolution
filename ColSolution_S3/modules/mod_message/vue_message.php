...
<HTML>
    ...
    <link href="css/message.css" rel="stylesheet" type="text/css" />
			...
			<BODY>
				...
				<HEADER>
					<a href="accueil.php"> <img class="logo" src="images/COL.png" alt="Logo du site"/> </a>
                ...
                <BODY>
                    ...
                    <NAV id="mainNav">
                        ...
                        <nav id="Annonce">
                            ...
                            <a class="menuLink" href="index.php?module=message&action=supprimer&idMessage=<?=$m['idMessage']?>"> <img class="icons" src="images/icons/map-marker.png" alt=""/>Supprimer</a>
                    ...
                    <MAIN>
                        ...
                        <?php
                            if($exp2['avatar'] != null) { 
						?>
						<a href="DepoAnnonce.php"> <img id="imgDes" src="../public/avatars/<?php echo $exp2['avatar'];?>" alt="Photo de profil"/> </a>
						<?php	
						}
						?>
						<?php
						if($exp2['avatar'] == null){
						?>
							<a href="DepoAnnonce.php"> <img id="imgDes" src="../public/avatars/defaults/pp.png" alt="Photo de profil"/> </a>
						<?php
						}
						?>
                        </div>
